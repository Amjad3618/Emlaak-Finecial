...
import '../../Widgets/form_and_date_picker/form_and_date_picker.dart' show CustomTextFormField;
...
class SarmayakariAccCreationphoneNumberScreen extends StatefulWidget {
  ...
  @override
  State<SarmayakariAccCreationphoneNumberScreen> createState() => _SarmayakariAccCreationphoneNumberScreenState();
}

class _SarmayakariAccCreationphoneNumberScreenState extends State<SarmayakariAccCreationphoneNumberScreen> {
    ...
    return  Scaffold(
      ...
      body: Padding(
        ...
        child: Column(children: [
          CustomText("Please Enter there you Pakistani Phone Number  ",fontSize: 30,fontWeight: FontWeight.bold,),
          SizedBox(height: 20,),
          CustomTextFormField(
